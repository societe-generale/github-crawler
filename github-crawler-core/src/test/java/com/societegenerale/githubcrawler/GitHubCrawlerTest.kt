...
class GitHubCrawlerTest {
    ...
    private val gitHubCrawlerProperties = GitHubCrawlerProperties(sourceControl= GithubConfig(), indicatorsToFetchByFile = mapOf(Pair(FileToParse(fileToParse, null), listOf(indicator))))
