...
//            val logMessage = firstValue as String
//         //   val command = (firstValue as GenericCommandMessage<SaveSyndicationFacilityCommand>).payload
//            assertThat(logMessage).isEqualTo("Bad Request details")
        }
